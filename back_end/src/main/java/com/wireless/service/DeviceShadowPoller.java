...
public class DeviceShadowPoller {
    ...
    private void parseAndSave(String body) {
        ...
        // 全量推送 7 个字段 (3D 新版自带防抖，不会冲突)
        Map<String, Object> wsData = new LinkedHashMap<>();
        wsData.put("Status_LED", p.get("Status_LED"));
        wsData.put("Status_ledRed", p.get("Status_ledRed"));
        wsData.put("Status_ledYellow", p.get("Status_ledYellow"));
        wsData.put("Status_beeper", p.get("Status_beeper"));
